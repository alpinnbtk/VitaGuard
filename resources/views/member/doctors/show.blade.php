    ...
    <div class="card shadow-sm" style="border-radius: 15px; border: none; overflow: hidden;">
        <div class="row g-0">
            <div class="col-md-4 text-center p-4 d-flex align-items-center justify-content-center" style="background-color: var(--surface);">
                <img src="{{ $doctor->image ? asset($doctor->image) : asset('images/doctors/default-article.jpg') }}" alt="{{ $doctor->name }}" class="img-fluid shadow-sm" style="width: 250px; height: 250px; object-fit: cover; border-radius: 15px; border: 4px solid white;">
            </div>
