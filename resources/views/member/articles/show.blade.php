...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow-sm" style="border-radius: 15px; border: none; overflow: hidden;">
        <img src="{{ $article->image ? (Str::startsWith($article->image, 'http') ? $article->image : asset($article->image)) : asset('images/articles/default-article.jpg') }}" class="card-img-top" alt="{{ $article->title }}" style="height: 400px; object-fit: cover;">
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <div class="d-flex align-items-center mb-4 text-muted" style="font-size: 0.9rem;">
                ...
                <div><i class="bi bi-tag me-1"></i> {{ $article->category->category_name ?? 'Umum' }}</div>
            </div>
