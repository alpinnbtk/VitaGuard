        ...
        @forelse ($articles as $article)
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm" style="border-radius: 15px; border: none; overflow: hidden;">
                    <img src="{{ $article->image ? (Str::startsWith($article->image, 'http') ? $article->image : asset($article->image)) : asset('images/articles/default-article.jpg') }}" class="card-img-top" alt="{{ $article->title }}" style="height: 220px; object-fit: cover;">
