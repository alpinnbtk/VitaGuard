...
<div class="card-custom" style="max-width: 700px;">
    <div class="card-header">
        <h5><i class="bi bi-plus-circle me-2"></i>Tambah Konsultasi Baru</h5>
    </div>
    <div class="p-4">
        <form action="{{ route('admin.transactions.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" name="consultation_date" id="consultation_date" class="form-control @error('consultation_date') is-invalid @enderror" value="{{ old('consultation_date') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="total_price" id="total_price" class="form-control @error('total_price') is-invalid @enderror" value="{{ old('total_price') }}" step="1000" min="0" required>
