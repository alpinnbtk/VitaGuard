...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <div>
        <h5 class="fw-semibold mb-0" style="color:#0f172a;">Edit Jadwal Praktik</h5>
        <p class="text-muted mb-0" style="font-size:0.8rem;">Perbarui hari dan jam praktik dokter.</p>
    </div>
</div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="time" name="start_time" id="start_time" class="form-control @error('start_time') is-invalid @enderror"
                       style="border-radius:8px;" value="{{ old('start_time', \Carbon\Carbon::parse($schedule->start_time)->format('H:i')) }}" required>
            ...
            <div class="col-md-6">
                ...
                <input type="time" name="end_time" id="end_time" class="form-control @error('end_time') is-invalid @enderror"
                       style="border-radius:8px;" value="{{ old('end_time', \Carbon\Carbon::parse($schedule->end_time)->format('H:i')) }}" required>
