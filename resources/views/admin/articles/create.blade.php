        ...
        <div class="p-4">
            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label for="category_id" class="form-label fw-medium">Kategori <span
                    ...
                    <div class="col-md-6">
                        <label for="author_id" class="form-label fw-medium">Penulis <span
                                class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="image" class="form-label fw-medium">Gambar Artikel <span class="text-danger">*</span></label>
