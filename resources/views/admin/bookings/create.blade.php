...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <div>
        <h5 class="fw-semibold mb-0" style="color:#0f172a;">Tambah Konsultasi Baru</h5>
        <p class="text-muted mb-0" style="font-size:0.8rem;">Buat data pemesanan konsultasi baru ke dalam sistem.</p>
    </div>
</div>
    ...
    <form action="{{ route('admin.bookings.store') }}" method="POST" id="adminBookingForm">
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary" style="border-radius:8px;">
                <i class="bi bi-floppy-fill me-1"></i>Simpan Konsultasi
            </button>
        </div>
    </form>
</div>
...
<script>
    ...
    function onDoctorChanged(select) {
